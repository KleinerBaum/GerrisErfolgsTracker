    ...
    <div className="dialog-backdrop" onMouseDown={onClose} role="presentation">
      ...
      >
        <header className="dialog-heading">
          <div>
            <span className="eyebrow">Privates Adressbuch</span>
  ...
  return (
    <div className="contacts-view">
      <section className="contacts-hero">
        <div><span className="eyebrow">Privat & zentral</span><h1>Kontakte</h1><p>Menschen, Kontaktdaten und persönliche Notizen an einem geschützten Ort.</p></div>
