...
## Unreleased
- Zeigt auf der Ziele-Seite unterhalb des KPI-Dashboards die offenen Aufgaben der Quadranten U+I sowie I+nU inklusive vorhandener
  Unterziele, bevor der Wochenchart angezeigt wird / Goals page now surfaces open tasks from the U+I and I+nU quadrants including
  their milestones beneath the KPI dashboard, above the weekly chart.
...
- Das Gamification-Panel in der Sidebar trägt nun die Überschrift **Gamification-Variante / Gamification variant**, um doppelte Beschriftungen zu vermeiden / The sidebar gamification panel now uses the **Gamification-Variante / Gamification variant** heading to avoid duplicate labels.
