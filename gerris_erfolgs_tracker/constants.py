...
NEW_EMAIL_TITLE_KEY: str = "new_email_title"
NEW_EMAIL_CONTEXT_KEY: str = "new_email_context"
NEW_EMAIL_RECIPIENT_KEY: str = "new_email_recipient"
NEW_EMAIL_TONE_KEY: str = "new_email_tone"
NEW_EMAIL_LENGTH_KEY: str = "new_email_length"
NEW_EMAIL_LANGUAGE_KEY: str = "new_email_language"
NEW_EMAIL_OUTPUT_KEY: str = "new_email_output"
NEW_EMAIL_DRAFT_META_KEY: str = "new_email_draft_meta"
NEW_EMAIL_FROM_AI_KEY: str = "new_email_from_ai"
NEW_EMAIL_RESET_TRIGGER_KEY: str = "new_email_reset_trigger"
