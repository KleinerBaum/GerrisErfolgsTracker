...
- Die Seitenleiste bündelt die Navigation zwischen **Ziele / Goals**, **Aufgaben / Tasks** und **Tagebuch / Journal**, während Gamification-Variante, AI-Schalter, Sicherheitsoptionen und Build-Info in das Header-Dropdown rechts neben **Journal** gewandert sind. Die App startet mit geöffneter Sidebar und lädt standardmäßig die Seite **Ziele / Goals** / The sidebar hosts navigation across **Goals**, **Tasks**, and **Journal**, while the gamification mode, AI toggle, safety controls, and build info moved into the header dropdown next to **Journal**. The app still opens with the sidebar expanded and defaults to the **Goals** page.
