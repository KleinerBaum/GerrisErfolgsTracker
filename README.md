...
- Ein neuer Abschnitt **Gelöst / Completed** auf der Seite **Ziele / Goals** erlaubt es, erledigte Aktivitäten mit einem Notizfeld zu dokumentieren, markiert die ausgewählte Aufgabe als erledigt, aktualisiert KPIs und Kategorie-Tachometer und zeigt freigeschaltete Gamification-Elemente als aufmunternde Pop-ups an / The **Ziele / Goals** page now includes a **Gelöst / Completed** quick action to log finished activities with an optional note, mark the chosen task as done, refresh KPIs and category gauges, and surface newly unlocked gamification rewards as cheerful pop-ups.
