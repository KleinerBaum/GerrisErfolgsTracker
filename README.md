...
- Im Block **Ziele im Überblick** steuerst du im Expander **Einstellungen**, welche Aufgaben in den KPIs und Kategorien berücksichtigt werden (z. B. nur Fokus-Tasks); zusätzlich regelst du dort Anzahl, Auswahl, Farbe und Darstellungsart der Tachometer (rund oder Balken) / The **Settings** expander inside **Ziele im Überblick / Goals at a glance** now lets you choose which tasks count toward KPIs and categories (e.g., focus tasks) and also configure how many gauges to show, which KPIs they display, plus their accent color and radial vs. bar style.
