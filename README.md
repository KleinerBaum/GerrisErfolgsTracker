...
- Der Bereich **Aktivität abhaken / Log activity** auf der Seite **Ziele** bietet einen Button **Gelöst / Completed**, der offene Aufgaben direkt abschließt; die KPI-Karten, Tachometer und Gamification-Popups werden sofort aktualisiert / The **Log activity** section on the **Goals** page ships a **Gelöst / Completed** button to finish open tasks instantly, refreshing KPI cards, gauges, and gamification popups right away.
